...
c = conn.cursor()
c.execute("CREATE TABLE IF NOT EXISTS mail (address TEXT PRIMARY KEY, occurrences INTEGER DEFAULT 0, status INTEGER DEFAULT 0)")
conn.commit()

res = c.execute("INSERT OR IGNORE INTO mail (address) VALUES (?)", (email,))
